            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome to Joke Factory</h1>
                        <p class="text-lead text-white">Register for your jokes</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    <input type="email" class="form-control" placeholder="Password"
                                        aria-label="Password" required v-model="password">
                                </div>
                                ...
                                <div class="text-center">
                                    <button type="button" class="btn bg-gradient-dark w-100 mt-2 mb-4" @click="signUp">Sign up</button>
                                </div>
                            </form>
                        </div>
                    </div>
